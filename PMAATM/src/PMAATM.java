...
class PMAATM extends JFrame implements ActionListener,MouseListener
{ 
...
public void Atmmain()
{
    ...
    private static class LogoAnimatorJPanel {
        ...
        private void addMouseListener(PMAATM aThis) {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }
    }

    private static class Withdrawal {

        private boolean current_abal;

        public Withdrawal() {
        }

        private Withdrawal(int accno, int wd) {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }
    }
    ...
    private static class Deposit {
        ...
        private Deposit(int accno, int deposi) {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }
    }
